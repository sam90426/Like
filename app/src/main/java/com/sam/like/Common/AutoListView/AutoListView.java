...
import com.sam.like.Utils.Utils;
...
public class AutoListView extends ListView implements OnScrollListener {
	 ...
	 * </p>
	 *
	 * @param resultSize 当前请求数据的页码
	 * @param allpagecount 全部数据的页码
	 */
	public void setResultSize(int resultSize,int allpagecount) {
		if (resultSize == 0) {
			isLoadFull = true;
		...
		}else if(resultSize==allpagecount){
			isLoadFull = true;
